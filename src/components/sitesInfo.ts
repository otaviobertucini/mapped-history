...
export const sitesInfo: SiteInfo[] = [
  ...
  },
  {
    ...
    description: `Do alto, é possível observar que a estrutura mantém o desenho quadrilátero tradicional das igrejas católicas europeias, sendo que a igreja está localizada à esquerda da torre, e à sua direita está o jardim interno da instituição. Ainda ao lado esquerdo da igreja, na pequena casa, funcionava o Grupo Escolar São Francisco de Assis. Nas demais edificações religiosas presentes na imagem, encontravam-se o salão paroquial e o Convento dos Freis Capuchinhos, responsáveis pela congregação.`,
